...
const ToothChart: React.FC = () => {
  const [selectedColor, setSelectedColor] = useState<string>("#FFFFFF"); // Default color is blue
  ...
  const handleClick = (toothId: string): void => {
    setToothColors((prevColors) => ({
      ...prevColors,
      [toothId]: selectedColor, // Update the color of the clicked tooth
    }));
  };

  // Function to get the color for each tooth
    ...
    <ScrollView style={styles.container}>
      ...
      {selectedColor && (
        <View style={styles.Pickercontainer}>
          <Text color={"black"}>Select a color: </Text>
          ...
          >
            ...
            <Picker.Item label="Black" value="#202121" />
